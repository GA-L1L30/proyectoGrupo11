...
class CategoryViewModel : ViewModel(){
    ...
    private fun fetchProducts() {
        _products.addAll(
            listOf(
                Product(imageRes = R.drawable.coke, title=  "Diet Coke",  description = "355ml, Price", price = "$1.99"),
                Product(imageRes = R.drawable.sprite, title=  "Sprite Can", description = "325ml, Price", price = "$1.50"),
